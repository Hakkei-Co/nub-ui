...
import './nub-accordion';
import '../nub-accordion-panel/nub-accordion-panel';

export default {
  title: 'Nubs/Accordion/Accordion',
  component: 'nub-accordion',
  parameters: {
    docs: {
      source: {
        code: `
  <nub-accordion label=label clean=clean single-panel=singlePanel>
    <nub-accordion-panel slot="panels">
  ...
  argTypes: {
    ...
    PanelsSlotContent: {
      description:
        '**Slot="panels"`<nub-accordion-panel>`**: <br> The only slot, named for query purposes. <br>Use only `<nub-accordion-panel>` components.',
