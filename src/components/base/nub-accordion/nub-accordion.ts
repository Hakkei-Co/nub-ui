...
import componentStyles from './nub-accordion.css.lit';
import { MobileController } from '../../controllers/mobile-controller';

/**
 * Accordion Component
 * @element nub-accordion
 * @slot panels: For nub-accordion-panels only.
 */
@customElement('nub-accordion')
export class NubAccordion extends NubElement {
  ...
  /**
   * ref to <nub-accordion-panels> in panels slot.
   */
   ...
   * child <nub-accordion-panel> elements when the accordion updates.
   */
