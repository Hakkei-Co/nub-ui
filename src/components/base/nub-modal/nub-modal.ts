...
import componentStyles from './nub-modal.css.lit';
 ...
 * @slot nub-modal--trigger - The trigger for the modal
 * @slot nub-modal--header - The header in the modal
 * @slot nub-modal--accessibility-description - The accessibility description which is used by screen readers.
 */
@customElement('nub-modal')
export class NubModal extends NubElement implements OutlineModalInterface {
  ...
  render(): TemplateResult {
    return html`
      ...
      >
        <slot name="nub-modal--trigger"></slot>
      </div>
  ...
  private _handleSlotChange(): void {
    this._hasHeaderSlot =
      this.querySelector('[slot="nub-modal--header"]') !== null;
    this._hasAccessibilityDescriptionSlot =
      this.querySelector('[slot="nub-modal--accessibility-description"]') !==
      null;
  }
    ...
    if (this.isOpen) {
      template = html`
        ...
        <slot
          ...
          name="nub-modal--accessibility-description"
          @slotchange="${this._handleSlotChange}"
        ></slot>
      `;
    }
