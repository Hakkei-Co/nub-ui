...
import componentStyles from './nub-code-block.css.lit';

/**
 * The NubCodeBlock component
 * @element nub-code-block
 */
@customElement('nub-code-block')
export class NubCodeBlock extends NubElement {
