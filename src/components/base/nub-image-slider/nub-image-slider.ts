...
import componentStyles from './nub-image-slider.css.lit';

/**
 * The Image Slider component
 * @element nub-image-slider
 * @slot image-<number> - slots are generated in code, component accepts stack of desired elements to display
 */
@customElement('nub-image-slider')
export class NubImageSlider extends NubElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'nub-image-slider': NubImageSlider;
  }
}
